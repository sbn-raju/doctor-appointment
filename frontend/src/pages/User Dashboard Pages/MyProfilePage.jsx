...
const MyProfilePage = () => {
  ...
  const handleSave = () => {
    if(formData.name == "" || formData.age == "" || formData.email == "" || formData.gender == "selectGender"){
      alert("Please fill all the details to save");
      return;
    }
    // api axios call
    setIsDisabled(true);
        ...
        <div className='mb-8 lg:mb-16 rounded-2xl bg-white shadow-md pb-4'>
          ...
          <div className='flex justify-end pt-4'>
            <div className='flex mx-4 md:mx-10'>
              <CommonButton 
                className='text-xs md:text-base bg-white border-[1px] border-green-4 px-2 py-1 md:py-0 rounded-md text-green-4 flex justify-center items-center mx-2'
                onClick={handleEdit}
              >
                  Edit
              ...
              <CommonButton 
                className='text-xs md:text-base bg-green-4 px-2 rounded-md text-white mx-2 flex justify-center items-center'
                onClick={handleSave}
              >
                Save
