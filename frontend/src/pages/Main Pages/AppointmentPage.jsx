...
const AppointmentPage = () => {
  ...
  return (
    <div className='h-auto p-6 my-10 bg-white'>
      ...
      <div className='py-8 px-16 bg-green-100 rounded-2xl flex flex-col justify-center items-center'>
        <div>
        ...
        <form onSubmit={handleSubmit(appointmentData)}>
          <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='w-full md:w-1/2 order-1 md:order-2 m-5'>
              ...
              <Input
              label="Choose your Docter *"
              type="text"
              placeholder="Select Docter"
              className="border-[1px] border-green-800 w-full h-10 rounded-[5px] mb-[4px]"
              {...register("setDocter", {required: true})}
              />
      ...
      <div className='flex flex-col justify-center items-center my-10'>
        <div>
          <p className='text-green-700 text-xl mb-10 mt-5 font-semibold'>Know your Docter</p>
        </div>
        <div>
          <div className='relative m-5 md:m-20'>
            <div className='w-full flex flex-col md:flex-row p-6 rounded-lg' style={{ boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)' }}>
              <div className='w-full md:w-1/5 flex justify-center md:justify-start'>
                <img className='w-36 md:absolute md:bottom-0 md:left-0 lg:left-10' src={docter} />
              </div>
