            ...
            <div key={index} className='mb-5 p-4 px-5 rounded-2xl border-[1px] border-custom-red bg-custom-yellow'>
              <div className='w-full flex'>
                <div className='w-3/5'>
                  ...
                  <div className="flex">
                    <p className='mr-3 test-sm'><span className='font-medium'>{appointment.Name}</span></p>
                    <p className='test-sm'>Status: <span className='font-medium text-red-500'>{appointment.Status}</span></p>
                  </div>
                </div>
                <div className='w-2/5 flex justify-end'>
                  <div className="w-full px-3 p-2 bg-white rounded-xl flex justify-between border-[1px] border-red-200">
                    ...
                    <div className='2/5 flex items-center'>
